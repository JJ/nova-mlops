...
* APIs: application interfaces are the best; in some cases open data portals
  ...
  other (like download size) limits. You will need some cachin/storage
...
You need to look for certain *contracts* in that data: for instance, a
quantity that will always increase, or two quantities that are related
should always add up in a certain way.
