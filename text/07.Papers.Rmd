...
so that we
do not include big chunks of scripting code into the GitHub action. In
this repository, the bin/md2html does that task:
...
These GitHub actions will need to look something like this:
