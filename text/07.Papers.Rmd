...
reference in other works, and specifying a license is not a naturla
...
publish directly from RStudio or your Rprogram. For instance, I
...
* [Figshare](https://figshare.com) can be used to upload any kind of
  artefacts, from papers through simple figures to datasets. Papers
